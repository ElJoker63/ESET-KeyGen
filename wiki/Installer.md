...
![Windows](https://github.com/ElJoker63/ESET-KeyGen/blob/main/img/successfully_installed.png)

---

#### Attempt to reinstall (if the installed executable is not corrupted)
![Windows](https://github.com/ElJoker63/ESET-KeyGen/blob/main/img/reinstallation_attempt.png)

---

#### Attempting to install without elevated permissions
![Windows](https://github.com/ElJoker63/ESET-KeyGen/blob/main/img/installer_permission_error.png)

---

#### Attempting to install from source code
![Windows](https://github.com/ElJoker63/ESET-KeyGen/blob/main/img/installation_from_source.png)
...
## This function exists in its current form because of [ElJoker63](https://github.com/ElJoker63) and [AdityaGarg8](https://github.com/AdityaGarg8)